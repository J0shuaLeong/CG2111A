...
if("TRUE" STREQUAL "TRUE")
  set(python_qt_binding_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/python_qt_binding)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'python_qt_binding' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/python_qt_binding/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/python_qt_binding/lib;/opt/ros/noetic/lib)
